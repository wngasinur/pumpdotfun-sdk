...
export class PumpFunSDK {
  ...
  async buy(
    ...
    let buyTx = await this.getBuyInstructionsBySolAmount(buyer, mint, buyAmountSol, false, slippageBasisPoints, commitment);
  ...
  async getBuyInstructionsBySolAmount(
    ...
    return await this.getBuyInstructions(buyer, mint, globalAccount.feeRecipient, buyAmount, buyAmountWithSlippage, skipAta);
  }
